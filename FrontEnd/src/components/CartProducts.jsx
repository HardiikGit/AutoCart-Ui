         ...
         <div className="PartsDetails d-flex flexcolumn" style={{ gap: '10px', padding: '20px' }}>
          ...
          <div className="d-flex align-items-center justify-space-between">
           ...
           <div className="RemoveCart">
            <button
             className="CartButton" style={{ fontSize: '14px', fontWeight: '700', textTransform: 'uppercase', padding: '10px 15px', background: '#e1e1e160', border: '1px solid #e1e1e160', borderRadius: '5px', color: 'var(--black-color)' }}
             onClick={() => removeFromCart(data.id)}>Remove</button>
           </div>
          </div>
         </div>
        </div>
