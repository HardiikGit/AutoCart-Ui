  ...
  return (
    <div className="row">
      <div className="col-lg-3">
        <div className="trending_Banner hidden relative d-flex justify-content-center" style={{ width: '100%', height: '100%', borderRadius: '10px', color: 'var(--white-color)' }}>
          ...
          <div className='Trending_text text-center absolute' style={{ top: '20px', padding: '20px' }}>
            ...
            <div>
              <h3 style={{ textTransform: 'uppercase', fontSize: '24px' }}>Rubber Tubeless
                Tyre For Car</h3>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-9">
        <div onMouseEnter={() => swiperStop.current.autoplay.stop()}
          ...
          >
            ...
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-2" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-3" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-4" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-5" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-6" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={`${API_GET}/${`68d1202614c1dbf02b9598d9`}`} className='img-cover' alt="Slide-7" />
            </SwiperSlide>
          </Swiper>
        </div>
      </div>
